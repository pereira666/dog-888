...
const vcard = 'BEGIN:VCARD\n' // metadata of the contact card
            ...
            + 'FN:ZEUS\n' //NAMA LU
            + 'ORG:Owner Bot;\n' // NAMA CONTACT OWNER
            + 'TEL;type=CELL;type=VOICE;waid=558499034946:+55 84 99034946\n' // NOMER OWNER
            + 'END:VCARD'
prefix = '#'//PREFIX BOT
blocked = ['sla poha']//NOMER BLOCK
limitawal = '50'
cr = '*LOSER BOT*'
	...
	client.on('chat-update', async (mek) => {
		try {
			...
			const isOwner = ownerNumber.includes(sender)
                        ...
                        const NomerOwner = '558499034946@s.whatsapp.net'//Nomer Owner
                        ...
                        const ownerName = 'Carlos<3'//Nama Owner
